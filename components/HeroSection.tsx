...
> READY TO ENGAGE...`;
  ...
  return (
    <section className="relative w-full py-12 md:py-20 px-4 md:px-6 overflow-hidden bg-slate-950 flex justify-center">
      {/* Background Decor */}
      <div className="absolute inset-0 grid-bg opacity-20 z-0"></div>
      <div className="absolute top-0 left-0 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl z-0 -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl z-0 translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-wrap gap-4 text-sm font-medium text-slate-400 justify-center lg:justify-start">
