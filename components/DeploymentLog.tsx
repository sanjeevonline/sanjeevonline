          ...
          <div key={item.id} className="relative pl-8 md:pl-12 group">
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-6 hover:border-slate-600 transition-all">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-4">
                ...
                <div className="flex items-center gap-2 text-xs font-mono text-slate-500 bg-slate-950 px-3 py-1 rounded border border-slate-800">
                  <span>{item.period}</span>
                </div>
              </div>

              <p className="text-slate-300 mb-6 italic border-l-2 border-slate-700 pl-4">
                "{item.description}"
              </p>
