      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 mb-12">
          <a 
            ...
            className="flex items-center justify-center gap-3 px-6 py-3 bg-slate-900 border border-slate-800 rounded-lg text-slate-300 hover:text-white hover:border-cyan-500 hover:bg-slate-800 transition-all"
          >
            <Mail size={18} />
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="flex items-center justify-center gap-3 px-6 py-3 bg-slate-900 border border-slate-800 rounded-lg text-slate-300 hover:text-white hover:border-blue-500 hover:bg-slate-800 transition-all"
          >
            <Linkedin size={18} />
